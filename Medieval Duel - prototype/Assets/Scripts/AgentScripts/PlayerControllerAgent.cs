...
public class PlayerControllerAgent : Agent {
    ...
    public float obstaclesStartPosition;
    ...
    void Start ()
    {
        ...
        obstaclesStartPosition = obstacle[0].transform.position.x;
    }
    ...
    public override void AgentReset()
    {
        ...
        foreach(var x in obstacles)
        {
            ...
            x.transform.position = new Vector3(obstaclesStartPosition + pom, x.transform.position.y, x.transform.position.z);
        }
    }
    ...
    public override void CollectObservations()
    {
        ...
        string[] detectableObjects = new string[] { "Enemy", "Wall" };
